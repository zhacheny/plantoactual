...
// //your settings 
// };
export const SafetyReport = new Mongo.Collection('safetyreport');
...
export const Taskrecord = new Mongo.Collection('taskrecord');
export const OperatorSignedList = new Mongo.Collection('operatorsignedlist');
// export const Cell = new Mongo.Collection('cell');
